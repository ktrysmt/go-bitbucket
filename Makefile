...
test/ci: test/unit test/mock ## run tests that do not require credentials (for CI)
...
.PHONY: test test/ci test/unit test/e2e test/swagger test/mock test/coverage help
